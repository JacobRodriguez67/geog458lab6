...
async function geojsonFetch() {
    ...
    let response;
    response = await fetch('assets/earthquakes2024.geojsonassets/earthquakes2024.geojson');
    ...
    map.on('load', () => { //simplifying the function statement: arrow with brackets to define a function
        ...
        numEarthquakes = magnitudes[1.0] + magnitudes[1.5] + magnitudes[2];
