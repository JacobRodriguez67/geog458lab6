...
!function(t, e) {
    ...
    function u(t) {
        return null == t || f(t) && 0 === t.length || "object" === s(t) && 0 === Object.keys(t).length
    }
    function h(t) {
    ...
    l.prototype.redraw = function(t, e) {
        var i, n, r, a, o, s, c, d, l, u, h, g, p, f, _, x, y, m, S, w, v, b, T, A, P, C, L, V, G, E, O, I = this, R = I.main, k = I.d3, D = I.config, F = I.getShapeIndices(I.isAreaType), X = I.getShapeIndices(I.isBarType), z = I.getShapeIndices(I.isLineType), M = I.hasArcType(), H = I.filterTargetsToShow(I.data.targets), N = I.xv.bind(I);
        if (i = B(t = t || {}, "withY", !0),
        ...
        u && D.legend_show ? I.updateLegend(I.mapToIds(I.data.targets), t, e) : g && I.updateDimension(!0),
        I.isCategorized() && 0 === H.length && I.x.domain([0, I.axes.x.selectAll(".tick").size()]),
        H.length ? (I.updateXDomain(H, c, d, l),
        ...
        (c || p) && H.length)
            if (D.axis_x_tick_culling && C) {
                ...
                I.svg.selectAll("." + Y.axisX + " .tick text").style("display", "block");
        ...
        I.updateXgridFocus(),
        R.select("text." + Y.text + "." + Y.empty).attr("x", I.width / 2).attr("y", I.height / 2).text(D.data_empty_label_text).transition().style("opacity", H.length ? 0 : 1),
        h && I.redrawEventRect(),
        I.updateGrid(S),
        ...
        D.subchart_show && I.redrawSubchart && I.redrawSubchart(n, e, S, w, F, X, z),
        I.isStanfordGraphType() && I.drawColorScale(),
        R.selectAll("." + Y.selectedCircles).filter(I.isBarType.bind(I)).selectAll("circle").remove(),
        t.flow && (A = I.generateFlow({
            targets: H,
            flow: t.flow,
        ...
        S && I.isTabVisible() ? (P = k.transition().duration(S),
        b = [],
        [I.redrawBar(_, !0, P), I.redrawLine(x, !0, P), I.redrawArea(f, !0, P), I.redrawCircle(E, O, !0, P), I.redrawText(y, m, t.flow, !0, P), I.redrawRegion(!0, P), I.redrawGrid(!0, P)].forEach(function(t) {
    ...
    l.prototype.getTranslate = function(t) {
        ...
        return "main" === t ? (e = o(n.margin.left),
        i = o(n.margin.top)) : "context" === t ? (e = o(n.margin2.left),
        i = o(n.margin2.top)) : "legend" === t ? (e = n.margin3.left,
    ...
    l.prototype.parseDate = function(t) {
        var e;
        return t instanceof Date ? e = t : "string" == typeof t ? e = this.dataTimeParse(t) : "object" === s(t) ? e = new Date(+t) : "number" != typeof t || isNaN(t) || (e = new Date(+t)),
    ...
    n.prototype.axis.max = function(t) {
        ...
        "object" === s(t) ? (C(t.x) && (i.axis_x_max = t.x),
    ...
    n.prototype.axis.min = function(t) {
        ...
        "object" === s(t) ? (C(t.x) && (i.axis_x_min = t.x),
    ...
    n.prototype.destroy = function() {
        var e = this.internal;
        if (window.clearInterval(e.intervalForObserveInserted),
    ...
    n.prototype.regions.remove = function(t) {
        var e, i, n, r = this.internal, a = r.config;
        return e = B(t = t || {}, "duration", a.transition_duration),
        i = B(t, "classes", [Y.region]),
        n = r.main.select("." + Y.regions).selectAll(i.map(function(t) {
            return "." + t
        })),
    ...
    n.prototype.show = function(t, e) {
        ...
        (i = n.svg.selectAll(n.selectorTargets(t))).transition().style("display", g() ? "block" : "initial", "important").style("opacity", 1, "important").call(n.endall, function() {
    ...
    l.prototype.transformForArcLabel = function(t) {
        var e, i, n, r, a, o = this, s = o.config, c = o.updateAngle(t), d = "", l = o.hasType("gauge");
        if (c && !l)
            e = this.svgArc.centroid(c),
            i = isNaN(e[0]) ? 0 : e[0],
            n = isNaN(e[1]) ? 0 : e[1],
            r = Math.sqrt(i * i + n * n),
            d = "translate(" + i * (a = o.hasType("donut") && s.donut_label_ratio ? h(s.donut_label_ratio) ? s.donut_label_ratio(t, o.radius, r) : s.donut_label_ratio : o.hasType("pie") && s.pie_label_ratio ? h(s.pie_label_ratio) ? s.pie_label_ratio(t, o.radius, r) : s.pie_label_ratio : o.radius && r ? (.375 < 36 / o.radius ? 1.175 - 36 / o.radius : .8) * o.radius / r : 0) + "," + n * a + ")";
    ...
    l.prototype.updateTargetsForArc = function(t) {
        var e, i = this, n = i.main, r = i.classChartArc.bind(i), a = i.classArcs.bind(i), o = i.classFocus.bind(i);
        (e = n.select("." + Y.chartArcs).selectAll("." + Y.chartArc).data(i.pie(t)).attr("class", function(t) {
            return r(t) + o(t.data)
        }).enter().append("g").attr("class", r)).append("g").attr("class", a),
    ...
    l.prototype.redrawArc = function(t, e, i) {
        ...
        d && (o = (a = c.selectAll("." + Y.arcs).selectAll("." + Y.arcLabelLine).data(l.arcData.bind(l))).enter().append("rect").attr("class", function(t) {
            return Y.arcLabelLine + " " + Y.target + " " + Y.target + "-" + t.data.id
        }).merge(a),
        1 === l.filterTargetsToShow(l.data.targets).length ? o.style("display", "none") : o.style("fill", function(t) {
    ...
    l.prototype.loadConfig = function(e) {
        ...
        Object.keys(a).forEach(function(t) {
            ...
            r = function t() {
                var e = n.shift();
                return e && i && "object" === s(i) && e in i ? (i = i[e],
                t()) : e ? void 0 : i
            }(),
            k(r) && (a[t] = r)
        })
    ...
    l.prototype.convertUrlToData = function(t, e, i, n, r) {
        var a, o, s = this, c = e || "csv";
        o = "json" === c ? (a = s.d3.json,
        s.convertJsonToData) : (a = "tsv" === c ? s.d3.tsv : s.d3.csv,
        s.convertXsvToData),
    ...
    l.prototype.convertXsvToData = function(t) {
        ...
        return 0 === t.length ? {
            ...
            rows: [e.reduce(function(t, e) {
                return Object.assign(t, (r = null,
                (n = e)in (i = {}) ? Object.defineProperty(i, n, {
                    value: r,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
    ...
    l.prototype.convertJsonToData = function(e, t) {
        var r, a = this, o = [];
        return t ? (t.x ? (r = t.value.concat(t.x),
    ...
    l.prototype.convertDataToTargets = function(t, n) {
        ...
        if (c(t) ? a = Object.keys(t[0]) : (a = t.keys,
        t = t.rows),
        r = a.filter(l.isX, l),
        ...
        (e = i.map(function(o, s) {
            ...
            return {
                ...
                values: t.map(function(t, e) {
                    ...
                    return l.isCustomX() && l.isCategorized() && !v(r) ? (0 === s && 0 === e && (u.axis_x_categories = []),
    ...
    l.prototype.getTotalDataSum = function() {
        ...
        if (void 0 !== t)
            return t;
        var i, n, r = (i = e.data.targets.filter(function(t) {
            return e.isTargetToShow(t.id)
        }).map(function(t) {
            return t.values
        }),
        Array.isArray(i) ? (n = []).concat.apply(n, a(i)) : []).map(function(t) {
            return t.value
        }).reduce(function(t, e) {
            return t + e
        }, 0);
        return e.addToCache("getTotalDataSum", r),
        r
    }
    ,
    ...
    l.prototype.generateTargetX = function(t, e, i) {
        var n = this;
        return n.isTimeSeries() ? t ? n.parseDate(t) : n.parseDate(n.getXValue(e, i)) : n.isCustomX() && !n.isCategorized() ? C(t) ? +t : n.getXValue(e, i) : i
    }
    ,
    ...
    l.prototype.findClosest = function(t, i, n) {
        var r, a = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 1 / 0, o = this;
        return t.filter(function(t) {
            return t && o.isBarType(t.id)
        }).forEach(function(t) {
            if (!r) {
                var e = o.main.select("." + Y.bars + o.getTargetSelectorSuffix(t.id) + " ." + Y.bar + "-" + t.index).node();
    ...
    l.prototype.getRatio = function(t, e) {
        ...
        if (e && r.data.shown.call(r).length)
            if (a = e.ratio || e.value,
            "arc" === t)
                if (n.hasType("gauge"))
                    a = (e.endAngle - e.startAngle) / (Math.PI * (n.config.gauge_fullCircle ? 2 : 1));
                else {
                ...
                e.ratio = d(e.value) && s && 0 < s[e.index] ? e.value / s[e.index] : 0,
                a = e.ratio
            }
        return i && a ? 100 * a : a
    }
    ...
    l.prototype.getYDomain = function(t, e, i) {
        ...
        if (n.isAxisNormalized(e))
            return [0, 100];
        var a, o, s, c, d, l, u, h, g, p, f = t.filter(function(t) {
            return n.axis.getId(t.id) === e
        }), _ = i ? n.filterByXDomain(f, i) : f, x = "y2" === e ? r.axis_y2_min : r.axis_y_min, y = "y2" === e ? r.axis_y2_max : r.axis_y_max, m = n.getYDomainMin(_), S = n.getYDomainMax(_), w = "y2" === e ? r.axis_y2_center : r.axis_y_center, v = n.hasType("bar", _) && r.bar_zerobased || n.hasType("area", _) && r.area_zerobased, b = "y2" === e ? r.axis_y2_inverted : r.axis_y_inverted, T = n.hasDataLabel() && r.axis_rotated, A = n.hasDataLabel() && !r.axis_rotated;
        if (m = C(x) ? x : C(y) ? m < y ? m : y - 10 : m,
        ...
        v && (g && (m = 0),
        p && (S = 0)),
        s = c = .1 * (o = Math.abs(S - m)),
        void 0 !== w && (S = w + (d = Math.max(Math.abs(m), Math.abs(S))),
        m = w - d),
        T)
            ...
            var P = n.getY(r["axis_".concat(e, "_type")], [0, r.axis_rotated ? n.width : n.height], [0, o]);
            s += P(l[1]),
            c += P(l[0])
        }
        return "y" === e && L(r.axis_y_padding) && (s = n.axis.getPadding(r.axis_y_padding, "top", s, o),
    ...
    l.prototype.getXDomainPadding = function(t) {
        var e, i, n, r, a = this.config, o = t[1] - t[0];
        return i = this.isCategorized() ? 0 : this.hasType("bar") ? 1 < (e = this.getMaxDataCount()) ? o / (e - 1) / 2 : .5 : .01 * o,
        "object" === s(a.axis_x_padding) && L(a.axis_x_padding) ? (n = C(a.axis_x_padding.left) ? a.axis_x_padding.left : i,
        r = C(a.axis_x_padding.right) ? a.axis_x_padding.right : i) : n = r = "number" == typeof a.axis_x_padding ? a.axis_x_padding : i,
        {
            left: n,
            right: r
        }
    ...
    l.prototype.drag = function(t) {
        var e, i, n, r, h, g, p, f, _ = this, a = _.config, o = _.main, x = _.d3;
        _.hasArcType() || a.data_selection_enabled && a.data_selection_multiple && (e = _.dragStart[0],
        i = _.dragStart[1],
        n = t[0],
        r = t[1],
        h = Math.min(e, n),
        ...
        o.select("." + Y.dragarea).attr("x", h).attr("y", p).attr("width", g - h).attr("height", f - p),
        o.selectAll("." + Y.shapes).selectAll("." + Y.shape).filter(function(t) {
            return a.data_selection_isselectable(t)
        }).each(function(t, e) {
            var i, n, r, a, o, s, c = x.select(this), d = c.classed(Y.SELECTED), l = c.classed(Y.INCLUDED), u = !1;
    ...
    l.prototype.dataLabelFormat = function(t) {
        ...
        return "function" == typeof i.format ? i.format : "object" === s(i.format) ? i.format[t] ? !0 === i.format[t] ? e : i.format[t] : function() {
            return ""
        }
        : e
    }
    ...
    l.prototype.redrawEventRect = function() {
        ...
        : null).on("mousemove", d.interaction_enabled ? function() {
            if (!s.dragging) {
                ...
                if (!s.hasArcType(t)) {
                    var e, i = c.mouse(this), n = h(s.findClosestFromTargets(t, i)), r = u(i, n);
                    if (!s.mouseover || n && n.id === s.mouseover.id && n.index === s.mouseover.index || (d.data_onmouseout.call(s.api, s.mouseover),
                    s.mouseover = void 0),
                    n && !s.mouseover && (d.data_onmouseover.call(s.api, n),
                    s.mouseover = n),
                    s.svg.select("." + Y.eventRect).style("cursor", r ? "pointer" : null),
        ...
        : null).on("click", d.interaction_enabled ? function() {
            ...
            if (!s.hasArcType(t)) {
                ...
                if (u(e, i))
                    if ((!d.data_selection_grouped || s.isStanfordType(i) ? [i] : s.filterByX(t, i.x)).forEach(function(t) {
                    ...
                    i) {
                        var n = s.main.selectAll("." + Y.shapes + s.getTargetSelectorSuffix(i.id)).select("." + Y.shape + "-" + i.index);
    ...
    l.prototype.regionWidth = function(t) {
        var e, i = this, n = i.config, r = i.regionX(t), a = "y" === t.axis ? i.y : i.y2;
    ...
    l.prototype.regionHeight = function(t) {
        var e, i = this, n = i.config, r = this.regionY(t), a = "y" === t.axis ? i.y : i.y2;
    ...
    l.prototype.getShapeOffset = function(t, d, e) {
        ...
        return function(r, a) {
            ...
            return i.forEach(function(t) {
                ...
                t.id !== r.id && d[t.id] === d[r.id] && u.indexOf(t.id) < u.indexOf(r.id) && (!v(e[a]) && +e[a].x == +r.x || (a = -1,
    ...
    l.prototype.updateTargetsForLine = function(t) {
        var e, i = this, n = i.config, r = i.classChartLine.bind(i), a = i.classLines.bind(i), o = i.classAreas.bind(i), s = i.classCircles.bind(i), c = i.classFocus.bind(i);
        (e = i.main.select("." + Y.chartLines).selectAll("." + Y.chartLine).data(t).attr("class", function(t) {
            return r(t) + c(t)
        }).enter().append("g").attr("class", r).style("opacity", 0).style("pointer-events", "none")).append("g").attr("class", a),
    ...
    l.prototype.generateDrawLine = function(t, o) {
        ...
        function i(t, e) {
            return 0 < c.data_groups.length ? n(t, e)[0][1] : l.call(s, t.id)(t.value)
        }
        var s = this
          , c = s.config
          , d = s.d3.line()
        ...
        return d = c.axis_rotated ? d.x(i).y(e) : d.x(e).y(i),
        c.line_connectNull || (d = d.defined(function(t) {
            return null != t.value
        })),
        function(t) {
            var e = c.line_connectNull ? s.filterRemoveNull(t.values) : t.values
              ...
              , r = 0
              , a = 0;
            return (s.isLineType(t) ? c.data_regions[t.id] ? s.lineWithRegions(e, i, n, c.data_regions[t.id]) : (s.isStepType(t) && (e = s.convertValuesToStep(e)),
            d.curve(s.getInterpolate(t))(e)) : (e[0] && (r = i(e[0].x),
            a = n(e[0].value)),
    ...
    l.prototype.lineWithRegions = function(t, c, d, e) {
        var i, n, r, a, l, o, s, u, h, g, p, f = this, _ = f.config, x = "M", y = f.isCategorized() ? .5 : 0, m = [];
        function S(t, e) {
            var i;
        ...
        if (k(e))
            for (i = 0; i < e.length; i++)
                m[i] = {},
                v(e[i].start) ? m[i].start = t[0].x : m[i].start = f.isTimeSeries() ? f.parseDate(e[i].start) : e[i].start,
                v(e[i].end) ? m[i].end = t[t.length - 1].x : m[i].end = f.isTimeSeries() ? f.parseDate(e[i].end) : e[i].end;
        function w(t) {
        ...
        r = f.isTimeSeries() ? function(t, e, i, n) {
            var r = t.x.getTime()
              ...
              , o = new Date(r + a * i)
              , s = new Date(r + a * (i + n));
            return w(_.axis_rotated ? [[d(l(i)), c(o)], [d(l(i + n)), c(s)]] : [[c(o), d(l(i))], [c(s), d(l(i + n))]])
        }
        : function(t, e, i, n) {
            return w(_.axis_rotated ? [[d(l(i), !0), c(a(i))], [d(l(i + n), !0), c(a(i + n))]] : [[c(a(i), !0), d(l(i))], [c(a(i + n), !0), d(l(i + n))]])
        }
        ,
        i = 0; i < t.length; i++) {
            if (v(m) || !S(t[i].x, m))
    ...
    l.prototype.generateDrawArea = function(t, e) {
        ...
        return s = o.axis_rotated ? s.x0(n).x1(r).y(i) : s.x(i).y0(o.area_above ? 0 : n).y1(r),
        o.line_connectNull || (s = s.defined(function(t) {
            return null !== t.value
        })),
        function(t) {
            var e = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values
              , i = 0
              , n = 0;
            return (a.isAreaType(t) ? (a.isStepType(t) && (e = a.convertValuesToStep(e)),
            s.curve(a.getInterpolate(t))(e)) : (e[0] && (i = a.x(e[0].x),
            n = a.getYScale(t.id)(e[0].value)),
            o.axis_rotated ? "M " + n + " " + i : "M " + i + " " + n)) || "M 0 0"
        }
    }
    ,
    ...
    l.prototype.getCurrentPaddingRight = function() {
        ...
        return i = C(e.padding_right) ? e.padding_right + 1 : e.axis_rotated ? 10 + n : !e.axis_y2_show || e.axis_y2_inner ? 2 + n + (t.axis.getY2AxisLabelPosition().isOuter ? 20 : 0) : r(t.getAxisWidthByAxisId("y2")) + n,
    ...
    l.prototype.getHorizontalAxisHeight = function(t) {
        var e = this
          , i = e.config
          , n = 30;
        return "x" !== t || i.axis_x_show ? "x" === t && i.axis_x_height ? i.axis_x_height : "y" !== t || i.axis_y_show ? "y2" !== t || i.axis_y2_show ? ("x" === t && !i.axis_rotated && i.axis_x_tick_rotate && (n = 30 + e.axis.getMaxTickWidth(t) * Math.cos(Math.PI * (90 - Math.abs(i.axis_x_tick_rotate)) / 180)),
        "y" === t && i.axis_rotated && i.axis_y_tick_rotate && (n = 30 + e.axis.getMaxTickWidth(t) * Math.cos(Math.PI * (90 - Math.abs(i.axis_y_tick_rotate)) / 180)),
    ...
    l.prototype.initBrush = function(t) {
        ...
        r.brush.updateExtent = function() {
            ...
            return t = r.config.axis_rotated ? [[0, e[0]], [r.width2, e[1]]] : [[e[0], 0], [e[1], r.height2]],
            this.extent(t),
            this
        }
        ,
    ...
    l.prototype.initSubchart = function() {
        ...
        t.axes.subx = i.append("g").attr("class", Y.axisX).attr("transform", t.getTranslate("subx")).attr("clip-path", e.axis_rotated ? "" : t.clipPathForXAxis)
    }
    ,
    ...
    l.prototype.updateTargetsForSubchart = function(t) {
        var e, i, n, r, a = this, o = a.context, s = a.config, c = a.classChartBar.bind(a), d = a.classBars.bind(a), l = a.classChartLine.bind(a), u = a.classLines.bind(a), h = a.classAreas.bind(a);
        (n = (r = o.select("." + Y.chartBars).selectAll("." + Y.chartBar).data(t)).enter().append("g").style("opacity", 0)).merge(r).attr("class", c),
        n.append("g").attr("class", d),
        (e = (i = o.select("." + Y.chartLines).selectAll("." + Y.chartLine).data(t)).enter().append("g").style("opacity", 0)).merge(i).attr("class", l),
        e.append("g").attr("class", u),
        e.append("g").attr("class", h),
        o.selectAll("." + Y.brush + " rect").attr(s.axis_rotated ? "width" : "height", s.axis_rotated ? a.width2 : a.height2)
    }
    ,
    ...
    l.prototype.getXForText = function(t, e, i) {
        var n, r, a = this, o = p(i);
        return n = a.config.axis_rotated ? (r = a.isBarType(e) ? 4 : 6,
        t[2][1] + r * (e.value < 0 ? -1 : 1)) : a.hasType("bar") ? (t[2][0] + t[0][0]) / 2 : t[0][0],
    ...
    l.prototype.xForTitle = function() {
        ...
        return 0 <= i.indexOf("right") ? t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width - e.title_padding.right : 0 <= i.indexOf("center") ? Math.max((t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width) / 2, 0) : e.title_padding.left
    }
    ,
    ...
    l.prototype.drawColorScale = function() {
        var t, e, i, n, r, a, o, s = this, c = s.d3, d = s.config, l = s.data.targets[0];
        if (t = isNaN(d.stanford_scaleWidth) ? 20 : d.stanford_scaleWidth,
        t < 0)
        ...
        s.colorScale = s.svg.append("g").attr("width", 50).attr("height", o).attr("class", Y.colorScale),
        s.colorScale.append("g").attr("transform", "translate(0, ".concat(d.stanford_padding.top, ")")).selectAll("bars").data(i).enter().append("rect").attr("y", function(t, e) {
            return 5 * e
        }).attr("x", 0).attr("width", t).attr("height", 5).attr("fill", function(t) {
            return a(t)
        }),
        r = c.scaleLog().domain([l.minEpochs, l.maxEpochs]).range([i[0] + d.stanford_padding.top + i[i.length - 1] + 5 - 1, i[0] + d.stanford_padding.top]),
        n = c.axisRight(r),
        "pow10" === d.stanford_scaleFormat ? n.tickValues([1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7]) : h(d.stanford_scaleFormat) ? n.tickFormat(d.stanford_scaleFormat) : n.tickFormat(c.format("d")),
        h(d.stanford_scaleValues) && n.tickValues(d.stanford_scaleValues(l.minEpochs, l.maxEpochs)),
        e = s.colorScale.append("g").attr("class", "legend axis").attr("transform", "translate(".concat(t, ",0)")).call(n),
        "pow10" === d.stanford_scaleFormat && e.selectAll(".tick text").text(null).filter(S).text(10).append("tspan").attr("dy", "-.7em").text(function(t) {
    ...
    l.prototype.xForColorScale = function() {
        return this.config.stanford_padding.right + p(this.colorScale.node()).width
    }
    ,
    ...
    l.prototype.getCentroid = function(t) {
        var e, i, n, r, a, o = w(t), s = 0, c = 0;
        for (e = 0,
        i = t.length - 1; e < t.length; i = e,
        e += 1)
            r = t[e],
            a = t[i],
            n = r.x * a.y - a.x * r.y,
    ...
    l.prototype.countEpochsInRegion = function(i) {
        var t, e, n = this.data.targets[0];
        return t = n.values.reduce(function(t, e) {
    ...
    l.prototype.updateStanfordElements = function(t) {
        var e, i, n, r, a, o, s = this, c = s.main, d = s.config, l = s.xvCustom.bind(s), u = s.yvCustom.bind(s), h = s.countEpochsInRegion.bind(s);
        (i = (e = c.select("." + Y.stanfordLines).style("shape-rendering", "geometricprecision").selectAll("." + Y.stanfordLine).data(d.stanford_lines)).enter().append("g").attr("class", function(t) {
        ...
        s.stanfordLines.select("line").transition().duration(t).attr("x1", function(t) {
            return d.axis_rotated ? u(t, "value_y1") : l(t, "value_x1")
        }).attr("x2", function(t) {
            return d.axis_rotated ? u(t, "value_y2") : l(t, "value_x2")
        }).attr("y1", function(t) {
        ...
        e.exit().transition().duration(t).style("opacity", 0).remove(),
        (o = (a = c.select("." + Y.stanfordTexts).selectAll("." + Y.stanfordText).data(d.stanford_texts)).enter().append("g").attr("class", function(t) {
        ...
        s.stanfordTexts.select("text").transition().duration(t).attr("x", function(t) {
            return d.axis_rotated ? u(t, "y") : l(t, "x")
        }).attr("y", function(t) {
            return d.axis_rotated ? l(t, "x") : u(t, "y")
        }).text(function(t) {
        ...
        (r = (n = c.select("." + Y.stanfordRegions).selectAll("." + Y.stanfordRegion).data(d.stanford_regions)).enter().append("g").attr("class", function(t) {
            return Y.stanfordRegion + (t.class ? " " + t.class : "")
        })).append("polygon").attr("points", function(t) {
            return t.points.map(function(t) {
                return [d.axis_rotated ? u(t, "y") : l(t, "x"), d.axis_rotated ? l(t, "x") : u(t, "y")].join(",")
            }).join(" ")
        }).style("opacity", 0),
        r.append("text").attr("x", function(t) {
            return s.getCentroid(t.points).x
        }).attr("y", function(t) {
            return s.getCentroid(t.points).y
        }).style("opacity", 0),
        s.stanfordRegions = r.merge(n),
        s.stanfordRegions.select("polygon").transition().duration(t).attr("points", function(t) {
            return t.points.map(function(t) {
                return [d.axis_rotated ? u(t, "y") : l(t, "x"), d.axis_rotated ? l(t, "x") : u(t, "y")].join(",")
            }).join(" ")
        ...
        s.stanfordRegions.select("text").transition().duration(t).attr("x", function(t) {
            return d.axis_rotated ? u(s.getCentroid(t.points), "y") : l(s.getCentroid(t.points), "x")
        }).attr("y", function(t) {
            return d.axis_rotated ? l(s.getCentroid(t.points), "x") : u(s.getCentroid(t.points), "y")
        }).text(function(t) {
            var e, i, n;
            return t.text ? (s.isStanfordGraphType() && (e = (n = h(t.points)).value,
            i = n.percentage),
            t.text(e, i)) : ""
    ...
    l.prototype.getTooltipContent = function(t, e, i, n) {
        ...
        p = p || (l.isTargetNormalized(t.id) ? function(t, e) {
    ...
    l.prototype.initZoom = function() {
        ...
        return i.zoom = n.zoom().on("start", function() {
            ...
            if ("scroll" === r.zoom_type) {
                var t = n.event.sourceEvent;
                t && "brush" === t.type || (i.redrawForZoom(),
        ...
        i.zoom.updateDomain = function() {
            return n.event && n.event.transform && i.x.domain(n.event.transform.rescaleX(i.subX).domain()),
            this
        }
        ,
