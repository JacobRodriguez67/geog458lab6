...
!function(t, n) {
    ...
    function jn(t) {
        if (t instanceof Xn)
            return new Xn(t.h,t.c,t.l,t.opacity);
    ...
    var Ha, ja = Array.prototype.map, Va = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
    function Xa(t) {
        ...
        return +n ? function(t, n) {
            ...
            return function(n) {
                ...
                function _(r, i) {
                    var o = ju([r, i])
                      , a = t(r, i);
                    e(s, l, f, h, d, p, s = a[0], l = a[1], f = r, h = o[0], d = o[1], p = o[2], Xs, n),
                    n.point(s, l)
                }
                function b() {
                    v.point = g,
    ...
    function Ks(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, v = 0, g = 0, y = 0, _ = 0, b = 0, m = null, x = df, w = null, M = Yf, N = .5;
        function T(t) {
        ...
        T.clipAngle = function(t) {
            return arguments.length ? (x = +t ? pf(m = t * cu) : (m = null,
            df),
            k()) : m * uu
        }
        ,
        T.clipExtent = function(t) {
            ...
            Yf) : yf(w = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]),
        ...
        T.precision = function(t) {
            return arguments.length ? (a = $s(u, N = t * t),
            k()) : bu(N)
        }
        ,
    ...
    function Ll(t, n) {
        ...
        for (e = 0; e < t.length; ++e)
            if (Ul(n, t[e]) && Bl(Yl(t[e], n), t))
                return [t[e], n];
        for (e = 0; e < t.length - 1; ++e)
            for (r = e + 1; r < t.length; ++r)
                if (Ul(Yl(t[e], t[r]), n) && Ul(Yl(t[e], n), t[r]) && Ul(Yl(t[r], n), t[e]) && Bl(Il(t[e], t[r], n), t))
                    return [t[e], t[r], n];
        throw new Error
    }
    function Ul(t, n) {
    ...
    function yh(t, n, e, r, i, o) {
        for (var a, u, c, f, s, l, h, d, p, v, g, y = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x; ) {
            ...
            a.dice ? rh(a, e, r, i, w ? r += f * s / w : o) : vh(a, e, r, w ? e += c * s / w : i, o),
            w -= s,
            b = m
        }
        return y
        ...
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
                    ...
                    s = c.length; f < s; ++f)
                        u.value += c[f].value;
                    u.dice ? rh(u, e, r, i, r += (o - r) * u.value / d) : vh(u, e, r, e += (i - e) * u.value / d, o),
                    d -= u.value
                }
            else
                t._squarify = a = yh(n, t, e, r, i, o),
                a.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n : 1)
    ...
    function Lh() {
        ...
        ,
        i.range = function(t) {
            return arguments.length ? (e = Dh.call(t),
            i) : e.slice()
        }
        ,
    ...
    function Xh() {
        ...
        function s() {
            return r = Math.min(a.length, u.length) > 2 ? jh : Hh,
            i = o = null,
            l
        }
        function l(n) {
        ...
        ,
        l.domain = function(t) {
            return arguments.length ? (a = Rh.call(t, Oh),
            f === Fh || (f = Ih(a)),
            s()) : a.slice()
        }
        ,
        l.range = function(t) {
            return arguments.length ? (u = Dh.call(t),
            s()) : u.slice()
        }
        ,
        ...
        ,
        l.clamp = function(t) {
            return arguments.length ? (f = t ? Ih(a) : Fh,
            l) : f !== Fh
        }
        ,
    ...
    vd.every = function(t) {
        return t = Math.floor(t),
        isFinite(t) && t > 0 ? t > 1 ? pd(function(n) {
        ...
        function w(t, n) {
            return function(e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f; )
                    ...
                    null != (i = wp[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0",
                    (o = n[r]) && (r = o(e, i)),
                    a.push(r),
                    c = u + 1);
            ...
            return function(e) {
                ...
                "V"in o) {
                    if (o.V < 1 || o.V > 53)
                        return null;
                    "w"in o || (o.w = 1),
                    "Z"in o ? (i = (r = _p(bp(o.y, 0, 1))).getUTCDay(),
                    r = i > 4 || 0 === i ? tp.ceil(r) : tp(r),
                    r = Zd.offset(r, 7 * (o.V - 1)),
                    o.y = r.getUTCFullYear(),
                    o.m = r.getUTCMonth(),
                    o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = yp(bp(o.y, 0, 1))).getDay(),
                    ...
                    i = "Z"in o ? _p(bp(o.y, 0, 1)).getUTCDay() : yp(bp(o.y, 0, 1)).getDay(),
                    o.m = 0,
    ...
    function Nv(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? rp(t) : rp.ceil(t),
    ...
    function jy() {
        ...
        return a.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : xy(+n),
            a) : t
        }
        ,
        a.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : xy(+t),
            a) : n
        }
        ,
        a.defined = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : xy(!!t),
            a) : e
        }
        ,
        a.curve = function(t) {
    ...
    function Vy() {
        ...
        return c.x = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : xy(+e),
            n = null,
            c) : t
        }
        ,
        ...
        ,
        c.x1 = function(t) {
            return arguments.length ? (n = null == t ? null : "function" == typeof t ? t : xy(+t),
            c) : n
        }
        ,
        c.y = function(t) {
        ...
        ,
        c.y1 = function(t) {
            return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : xy(+t),
            c) : r
        }
        ,
        ...
        c.defined = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : xy(!!t),
            c) : i
        }
        ,
        c.curve = function(t) {
    ...
    function i_(t) {
        ...
        ,
        a.x = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : xy(+t),
            a) : r
        }
        ,
        a.y = function(t) {
    ...
    var c_ = {
      ...
      , M_ = {
        draw: function(t, n) {
            ...
            t.lineTo(o, a),
            t.lineTo(u, c),
            t.lineTo(-.5 * r - m_ * i, m_ * r + -.5 * i),
            t.lineTo(-.5 * o - m_ * a, m_ * o + -.5 * a),
            t.lineTo(-.5 * u - m_ * c, m_ * u + -.5 * c),
            t.lineTo(-.5 * r + m_ * i, -.5 * i - m_ * r),
            t.lineTo(-.5 * o + m_ * a, -.5 * a - m_ * o),
            t.lineTo(-.5 * u + m_ * c, -.5 * c - m_ * u),
            t.closePath()
        }
    }
    ...
    Q_.prototype = {
        ...
        point: function(t, n) {
            ...
            (t = +t) !== this._x1 || n !== this._y1) {
                ...
                case 2:
                    this._point = 3,
                    Z_(this, W_(this, e = $_(this, t, n)), e);
                    break;
                default:
        ...
        lineEnd: function() {
            ...
            if (e)
                ...
                2 === e)
                    ...
                    for (var r = nb(t), i = nb(n), o = 0, a = 1; a < e; ++o,
                    ++a)
                ...
                for (i = 0; i < g; ++i)
                    if (o = Fb[i]) {
                        ...
                        f = c.length; u < f; )
                            ...
                            l = (s = Nb(o, Ib[c[++u % f]]))[0],
                            h = s[1],
                            (Math.abs(p - l) > Hb || Math.abs(v - h) > Hb) && (c.splice(u, 0, Ib.push(bb(a, d, Math.abs(p - t) < Hb && r - v > Hb ? [t, Math.abs(l - t) < Hb ? h : r] : Math.abs(v - r) < Hb && e - p > Hb ? [Math.abs(h - r) < Hb ? l : e, r] : Math.abs(p - e) < Hb && v - n > Hb ? [e, Math.abs(l - e) < Hb ? h : n] : Math.abs(v - n) < Hb && p - t > Hb ? [Math.abs(h - n) < Hb ? l : t, n] : null)) - 1),
                            ++f);
                        f && (y = !1)
                    }
                if (y) {
                    ...
                    for (i = 0,
                    y = null; i < g; ++i)
                        (o = Fb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && (x = m,
                        y = o);
                    if (y) {
                        var w = [t, n]
                          , M = [t, r]
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length)
                    for (var i, o, a, u = e.site, c = -1, f = n[i[o - 1]], s = f.left === u ? f.right : f.left; ++c < o; )
                        ...
                        a && s && r < a.index && r < s.index && Vb(u, a, s) < 0 && t.push([u.data, a.data, s.data])
            }),
            t
        },
        links: function() {
    ...
    t.arc = function() {
        var t = Dy
          ...
          , u = null;
        function c() {
            var c, f, s = +t.apply(this, arguments), l = +n.apply(this, arguments), h = i.apply(this, arguments) - Py, d = o.apply(this, arguments) - Py, p = wy(d - h), v = d > h;
            if (u || (u = c = no()),
            l < s && (f = l,
            l = s,
            s = f),
            l > Ey)
                if (p > zy - Ey)
                    ...
                    u.arc(0, 0, l, h, d, !v),
                    s > Ey && (u.moveTo(s * Ny(d), s * Sy(d)),
                    u.arc(0, 0, s, d, h, v));
                else {
                    var g, y, _ = h, b = d, m = h, x = d, w = p, M = p, N = a.apply(this, arguments) / 2, T = N > Ey && (r ? +r.apply(this, arguments) : ky(s * s + l * l)), A = Ay(wy(l - s) / 2, +e.apply(this, arguments)), S = A, k = A;
                    if (T > Ey) {
                        var E = Ry(T / s * Sy(N))
                          , C = Ry(T / l * Sy(N));
                        (w -= 2 * E) > Ey ? (m += E *= v ? 1 : -1,
                    ...
                    M > Ey ? k > Ey ? (g = By(O, B, P, z, l, k, v),
                    y = By(L, U, R, D, l, k, v),
                    u.moveTo(g.cx + g.x01, g.cy + g.y01),
                    k < A ? u.arc(g.cx, g.cy, k, My(g.y01, g.x01), My(y.y01, y.x01), !v) : (u.arc(g.cx, g.cy, k, My(g.y01, g.x01), My(g.y11, g.x11), !v),
                    u.arc(0, 0, l, My(g.cy + g.y11, g.cx + g.x11), My(y.cy + y.y11, y.cx + y.x11), !v),
                    u.arc(y.cx, y.cy, k, My(y.y11, y.x11), My(y.y01, y.x01), !v))) : (u.moveTo(P, z),
                    u.arc(0, 0, l, _, b, !v)) : u.moveTo(P, z),
                    s > Ey && w > Ey ? S > Ey ? (g = By(R, D, L, U, s, -S, v),
                    y = By(P, z, O, B, s, -S, v),
                    u.lineTo(g.cx + g.x01, g.cy + g.y01),
                    S < A ? u.arc(g.cx, g.cy, S, My(g.y01, g.x01), My(y.y01, y.x01), !v) : (u.arc(g.cx, g.cy, S, My(g.y01, g.x01), My(g.y11, g.x11), !v),
                    u.arc(0, 0, s, My(g.cy + g.y11, g.cx + g.x11), My(y.cy + y.y11, y.cx + y.x11), v),
                    u.arc(y.cx, y.cy, S, My(y.y11, y.x11), My(y.y01, y.x01), !v))) : u.arc(0, 0, s, x, m, v) : u.lineTo(R, D)
                }
            else
                u.moveTo(0, 0);
            if (u.closePath(),
        ...
        c.endAngle = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : xy(+t),
            c) : o
        }
        ,
        c.padAngle = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : xy(+t),
            c) : a
        }
        ,
        c.context = function(t) {
    ...
    t.drag = function() {
        ...
        d.touchable = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : Vt(!!t),
            d) : c
        }
        ,
        d.on = function() {
    ...
    t.geoCircle = function() {
        ...
        return a.center = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : Vc([+t[0], +t[1]]),
            a) : e
        }
        ,
        a.radius = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Vc(+t),
            a) : r
        }
        ,
        a.precision = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : Vc(+t),
            a) : i
        }
        ,
        a
    ...
    t.geoIdentity = function() {
        ...
        return o = {
            ...
            clipExtent: function(r) {
                ...
                Yf) : yf(h = +r[0][0], t = +r[0][1], n = +r[1][0], e = +r[1][1]),
                p()) : null == h ? null : [[h, t], [n, e]]
            },
            scale: function(t) {
                return arguments.length ? (l = ml((a = +t) * f, a * s, u, c),
                p()) : a
            },
            translate: function(t) {
                return arguments.length ? (l = ml(a * f, a * s, u = +t[0], c = +t[1]),
                p()) : [u, c]
            },
            reflectX: function(t) {
                return arguments.length ? (l = ml(a * (f = t ? -1 : 1), a * s, u, c),
                p()) : f < 0
            },
            reflectY: function(t) {
                return arguments.length ? (l = ml(a * f, a * (s = t ? -1 : 1), u, c),
                p()) : s < 0
            },
    ...
    t.pack = function() {
        ...
        function i(i) {
            return i.x = n / 2,
            i.y = e / 2,
            t ? i.eachBefore(Jl(t)).eachAfter(th(r, .5)).eachBefore(nh(1)) : i.eachBefore(Jl(Kl)).eachAfter(th(Zl, 1)).eachAfter(th(r, i.r / Math.min(n, e))).eachBefore(nh(Math.min(n, e) / (2 * i.r))),
            i
        }
        ...
        i.padding = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : Ql(+t),
            i) : r
        }
        ,
        i
    ...
    t.pie = function() {
        var t = Gy
          ...
          , o = xy(0);
        function a(a) {
            var u, c, f, s, l, h = a.length, d = 0, p = new Array(h), v = new Array(h), g = +r.apply(this, arguments), y = Math.min(zy, Math.max(-zy, i.apply(this, arguments) - g)), _ = Math.min(Math.abs(y) / h, o.apply(this, arguments)), b = _ * (y < 0 ? -1 : 1);
            for (u = 0; u < h; ++u)
    ...
    t.ribbon = function() {
        ...
        function a() {
            ...
            u)), l = r.apply(this, u) - Vi, h = i.apply(this, u) - Vi, d = s * Ii(l), p = s * Hi(l), v = +e.apply(this, (u[0] = f,
            u)), g = r.apply(this, u) - Vi, y = i.apply(this, u) - Vi;
            if (o || (o = a = no()),
            o.moveTo(d, p),
            o.arc(0, 0, s, l, h),
    ...
    t.scaleIdentity = function t(n) {
        ...
        r.domain = r.range = function(t) {
            return arguments.length ? (n = Rh.call(t, Oh),
            r) : n.slice()
        }
        ,
    ...
    t.scaleQuantile = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = Dh.call(t),
            u()) : o.slice()
        }
        ,
    ...
    t.scaleQuantize = function t() {
        ...
        ,
        c.range = function(t) {
            return arguments.length ? (o = (u = Dh.call(t)).length - 1,
            f()) : u.slice()
        }
        ,
    ...
    t.scaleThreshold = function t() {
        ...
        ,
        a.range = function(t) {
            return arguments.length ? (r = Dh.call(t),
            o = Math.min(e.length, r.length - 1),
            a) : r.slice()
        }
        ,
    ...
    t.stack = function() {
        ...
        return i.keys = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : xy(n_.call(n)),
            i) : t
        }
        ,
        i.value = function(t) {
        ...
        ,
        i.order = function(t) {
            return arguments.length ? (n = null == t ? ib : "function" == typeof t ? t : xy(n_.call(t)),
            i) : n
        }
        ,
        i.offset = function(t) {
            return arguments.length ? (e = null == t ? rb : t,
            i) : e
        }
        ,
        i
    ...
    t.stratify = function() {
        ...
        function e(e) {
            ...
            for (i = 0; i < s; ++i)
                r = e[i],
                u = l[i] = new Rl(r),
                null != (c = t(r, i, e)) && (c += "") && (h[f = ih + (u.id = c)] = f in h ? ah : u);
            for (i = 0; i < s; ++i)
                if (u = l[i],
                null != (c = n(e[i], i, e)) && (c += "")) {
                    if (!(a = h[ih + c]))
        ...
        return e.id = function(n) {
            return arguments.length ? (t = Wl(n),
            e) : t
        }
        ,
        e.parentId = function(t) {
            return arguments.length ? (n = Wl(t),
            e) : n
        }
        ,
        e
    ...
    t.tree = function() {
            ...
            var c = function(t) {
                for (var n, e, r, i, o, a = new ph(t,0), u = [a]; n = u.pop(); )
                    if (r = n._.children)
                        ...
                        i = o - 1; i >= 0; --i)
                            u.push(e = n.children[i] = new ph(r[i],i)),
                            e.parent = n;
                return (a.parent = new ph(null,0)).children = [a],
                a
            }(i);
            if (c.eachAfter(o),
            c.parent.m = -c.z,
        ...
        function o(n) {
            ...
            n.parent.A = function(n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = lh(u),
                    o = sh(o),
                    u && o; )
                        c = sh(c),
                        (a = lh(a)).a = n,
                        (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (hh(dh(u, n, r), n, i),
                        f += i,
                        s += i),
                        l += u.m,
                        f += o.m,
    ...
    t.treemap = function() {
        ...
        s.paddingInner = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : Ql(+t),
            s) : o
        }
        ,
        ...
        s.paddingTop = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : Ql(+t),
            s) : a
        }
        ,
        s.paddingRight = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : Ql(+t),
            s) : u
        }
        ,
        s.paddingBottom = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : Ql(+t),
            s) : c
        }
        ,
        s.paddingLeft = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : Ql(+t),
            s) : f
        }
        ,
        s
    ...
    t.voronoi = function() {
        ...
        ,
        r.x = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : sb(+n),
            r) : t
        }
        ,
        r.y = function(t) {
            return arguments.length ? (n = "function" == typeof t ? t : sb(+t),
            r) : n
        }
        ,
        r.extent = function(t) {
    ...
    ,
    t.zoom = function() {
        var n, e, r = nm, i = em, o = am, a = im, u = om, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], s = 250, l = Ie, h = I("start", "zoom", "end"), d = 500, p = 150, v = 0;
        function g(t) {
        ...
        g.wheelDelta = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : $b(+t),
            g) : a
        }
        ,
        g.filter = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : $b(!!t),
            g) : r
        }
        ,
        g.touchable = function(t) {
            return arguments.length ? (u = "function" == typeof t ? t : $b(!!t),
            g) : u
        }
        ,
        g.extent = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : $b([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            g) : i
        }
        ,
